...
const ProductCartModal = () => {
  ...
  const totalAmount = (function totalAmountOnCart() {
    let total = 0;
    cart.map((product) => {
  ...
  return (
    <>
      <div
        className="absolute right-0 top-120 z-10"
                        ...
                        >
                          {cart.map((product) => (
                            <div classNameName="flow-root">
                              <ul
                                role="list"
                                classNameName="-my-6 divide-y divide-gray-200"
                              >
                                <li classNameName="flex py-6">
                                  <div classNameName="size-24 shrink-0 overflow-hidden rounded-md border border-gray-200">
                                    <img
                                      src={product.image}
                                      alt="Salmon orange fabric pouch with match zipper, gray zipper pull, and adjustable hip belt."
                                      classNameNameName="size-full object-cover"
                                    />
                                  </div>
